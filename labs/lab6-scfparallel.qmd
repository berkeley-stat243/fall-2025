...
for this class we'll use only the `low` partition. It's the default, so you won't
...
additional space or request access to the `/scratch` filesystem. The latter is a
...
`data.csv` (you can find it [here](https://github.com/berkeley-stat243/fall-2025/tree/main/labs/lab6-scfparallel))
:
