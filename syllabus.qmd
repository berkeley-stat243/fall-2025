...
Do not rely on any details here for the course for 2025 as this is still being updated.
:::
...
-   **When to see us about an assignment**: We're here to help,
    ...
    futilely going around in circles for a long time getting nowhere. That
...
-   Primary materials: Course notes on course webpage/GitHub and SCF tutorials.
...
large language model-enabled tools such as ChatBots and AI-assisted coding. The following
...
For components #1 and #3, many of you will get a score of 1 for some
problem sets as you develop good presentation and coding practices.
