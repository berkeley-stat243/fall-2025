...
Interface) that serves data or allows other interactions. REST is a
 popular API standard/style. REST uses HTTP requests. When using REST, we access *resources*, which might be a Facebook
...
that represents the each character in bytes.
